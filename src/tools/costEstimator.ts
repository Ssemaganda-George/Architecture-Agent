...
export class CostEstimator {
  ...
  async estimateCost(brief: ProjectBrief, context: string): Promise<CostBreakdown> {
    const prompt = `You are an expert construction cost estimator specializing in Ugandan construction. Using the brief below and local Ugandan construction context, estimate total cost in Ugandan Shillings (UGX). Provide a realistic cost breakdown.\n\nReturn ONLY valid JSON with these exact top-level fields: totalCost, currency, labour, materials, equipment, transport, professionalFees, contingency, assumptions. Do not nest these under another object. Do not wrap it in markdown code fences or include any extra text.\n\nAll monetary values must be in UGX. Use realistic Ugandan market rates:\n- Labour: 30-35% of total\n- Materials: 45-50% of total\n- Equipment: 5-8% of total\n- Transport: 3-5% of total\n- Professional Fees: 8-12% of total\n- Contingency: 5-10% of total\n\nBrief:\n${JSON.stringify(brief, null, 2)}\n\nContext:\n${context}`;
